...
Prioridade média:
5. publicar matriz de acesso e revisão periódica
6. consolidar inventário de dados pessoais e mapa LGPD
7. formalizar runbooks de incidente, DR e restore com evidência de teste
8. consolidar relatório de testes de segurança e vulnerabilidades

Prioridade baixa:
9. criar pacote executivo para auditoria externa
10. criar checklist anual de revisão de compliance
